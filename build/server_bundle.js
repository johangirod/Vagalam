...
/******/ 	var hotCurrentHash = "8a6b9495e0d3172a3f3b"; // eslint-disable-line no-unused-vars
...
/* exports provided: STARTING_POINT, getLine */
/* exports used: STARTING_POINT, getLine */
/*!******************************!*\
  !*** ./src/Trip/Map/data.js ***!
  \******************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getLine = endingPoint => __WEBPACK_IMPORTED_MODULE_3__turf_line_slice___default()(STARTING_POINT, endingPoint, pathLineString);
/* harmony export (immutable) */ __webpack_exports__["b"] = getLine;
...
const withSleepPoints = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_freactal__["provideState"])({
    ...
    computed: {
        displayedSleepPoints: ({ sleepLocations, currentSleepLocation }) => sleepLocations.slice(0, sleepLocations.indexOf(currentSleepLocation) + 1).map(getCoordinates)
    }
});

const Map = ({ state: { displayedSleepPoints, currentSleepLocation }, effects: { updateMap } }) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    Mapbox.Map,
    {
    ...
    currentSleepLocation ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Mapbox.GeoJSONLayer, {
        data: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__data__["b" /* getLine */])(getCoordinates(currentSleepLocation)),
        lineLayout: {
            'line-join': 'round',
            'line-cap': 'round'
        },
...
/***/ 2:
/* no static exports found */
/* exports used: last, compose, pipe, map, unnest */
/*!************************!*\
  !*** external "ramda" ***!
  \************************/
/***/ (function(module, exports) {
