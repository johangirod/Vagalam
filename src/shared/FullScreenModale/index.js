        ...
        return (
            ...
            >
                <div className={s.modale} role="presentation" onKeyDown={this.handleKeyDown}>
                    ...
                    <p>
                        Pour profiter un max des manifiques photos, je conseille de naviguer le blog
                        en plein écran (vous pourrez revenir en mode
                        normal à tout moment en appuyant sur ESC)
                    </p>
                    <Button
                        onClick={this.handleGoFullScreen}
                        style={{ margin: '40px' }}
                    >
